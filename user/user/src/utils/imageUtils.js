 ...
 * @returns {string} 图片路径
 */
export function getMerchantImage(merchantName, defaultImage = '/src/assets/placeholder.png') {
  ...
  if (name.startsWith('老乡鸡')) {
    return '/src/assets/merchants/laoxiangji.png';
  } else if (name.startsWith('星巴克')) {
    return '/src/assets/merchants/xingbake.png';
  } else if (name.startsWith('熊大爷')) {
    return '/src/assets/merchants/xiongdaye.png';
  } else if (name.endsWith('可星(同济大学店)')) {
    return '/src/assets/merchants/taco.png';
  } else if (name.startsWith('小段')) {
    return '/src/assets/merchants/xiaoduan.png';
  } else if (name.startsWith('沙县')) {
    return '/src/assets/merchants/shaxian.png';
  } else if (name.startsWith('烤鱼')) {
    return '/src/assets/merchants/kaoyu.png';
  } else if (name.startsWith('老上海')) {
    return '/src/assets/merchants/laoshanghai.png';
  } else if (name.startsWith('融柳')) {
    return '/src/assets/merchants/rongliu.png';
  }else if (name.startsWith('福荣')) {
    return '/src/assets/merchants/furong.png';
  }
