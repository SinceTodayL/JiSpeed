...
namespace JISpeed.Core.Interfaces.IRepositories.Merchant
{
    ...
    public interface ISalesStatRepository
    {
        ...
        // <param name="statType">统计类型</param>
        // <returns>销售统计列表</returns>
        Task<List<SalesStat>> GetByMerchantIdAndStatTypeAsync(string merchantId, int statType);
        ...
        // <param name="endTime">结束时间</param>
        // <returns>销售统计列表</returns>
        Task<List<SalesStat>> GetByMerchantIdAndTimeRangeAsync(string merchantId, DateTime startTime, DateTime endTime);
